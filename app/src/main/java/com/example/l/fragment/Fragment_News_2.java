...
import com.example.l.adapter.MyNews2Fadapter;
import com.example.l.been.News2;
 ...
 */
public class Fragment_News_2 extends Fragment {
    PullToRefreshListView listView;
    List<News2.ListBean> list;
    MyNews2Fadapter adapter;
    HandlerUtils handlerUtils;
    List<Fragment> handFragment;
    MyHFadapter handeradapter;
    int num=1;
    int i=0;
    private static final String URL="http://api.fengniao.com/app_ipad/news_list.php?appImei=000000000000000&osType=Android&osVersion=4.1.1&cid=296&page=";
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    Gson js = new Gson();
                    News2 jsonE = js.fromJson(jsonString, News2.class);
                    list.addAll(jsonE.getList());
                    adapter=new MyNews2Fadapter(getActivity(),handlerUtils,list);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        View view1= (View) LayoutInflater.from(getActivity()).inflate(R.layout.headerview2,null);
        final ViewPager viewPager= (ViewPager) view1.findViewById(R.id.vp_handId2);
        handFragment.add(new Fragment_Hand_21());
        handFragment.add(new Fragment_Hand_22());
        handFragment.add(new Fragment_Hand_23());
