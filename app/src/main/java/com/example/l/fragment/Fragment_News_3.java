...
import com.example.l.been.News3;
 ...
 */
public class Fragment_News_3 extends Fragment {
    PullToRefreshListView listView;
    List<News3.ListBean> list;
    MyNews3Fadapter adapter;
    HandlerUtils handlerUtils;
    List<Fragment> handFragment;
    MyHFadapter handeradapter;
    int num=1;
    int i=0;
    private static final String URL="http://api.fengniao.com/app_ipad/news_list.php?appImei=000000000000000&osType=Android&osVersion=4.1.1&cid=192&page=";
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    Gson js = new Gson();
                    News3 jsonE = js.fromJson(jsonString, News3.class);
                    list.addAll(jsonE.getList());
                    adapter=new MyNews3Fadapter(getActivity(),handlerUtils,list);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        View view1= (View) LayoutInflater.from(getActivity()).inflate(R.layout.headerview3,null);
        final ViewPager viewPager= (ViewPager) view1.findViewById(R.id.vp_handId3);
        handFragment.add(new Fragment_Hand_31());
        handFragment.add(new Fragment_Hand_32());
        handFragment.add(new Fragment_Hand_33());
