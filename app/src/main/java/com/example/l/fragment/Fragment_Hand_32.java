 ...
 */
public class Fragment_Hand_32 extends Fragment{
    List<NHand3> list;
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    String text= list.get(1).getTitle();
                    textView.setText(text);
                    String imageurl= list.get(1).getPic_src();
...
//        gridView= (PullToRefreshGridView) view.findViewById(R.id.L_picId);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String web_url = list.get(1).getWeb_url();
