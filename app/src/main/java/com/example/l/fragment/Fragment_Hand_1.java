...
import com.example.l.been.NHand1;
 ...
 */
public class Fragment_Hand_1 extends Fragment {
    ...
    private static final String URL="http://api.fengniao.com/app_ipad/focus_pic.php?mid=19928?appImei=000000000000000&osType=Android&osVersion=4.1.1";
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    Gson js = new Gson();
                    list= js.fromJson(jsonString,new TypeToken<List<NHand1>>(){}.getType());
