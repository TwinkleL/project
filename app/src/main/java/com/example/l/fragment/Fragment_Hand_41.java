...
import com.example.l.been.NHand4;
 ...
 */
public class Fragment_Hand_41 extends Fragment {
    ...
    private static final String URL="http://api.fengniao.com/app_ipad//focus_pic.php?appImei=000000000000000&osType=Android&osVersion=4.1.1&mid=19931";
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    Gson js = new Gson();
                    list= js.fromJson(jsonString,new TypeToken<List<NHand4>>(){}.getType());
