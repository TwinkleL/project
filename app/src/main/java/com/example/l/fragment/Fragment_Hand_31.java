...
import com.example.l.been.NHand3;
...
/**
 * Created by L on 2016/9/7.
 */
public class Fragment_Hand_31 extends Fragment{
    List<NHand3> list;
    ...
    private static final String URL="http://api.fengniao.com/app_ipad//focus_pic.php?appImei=000000000000000&osType=Android&osVersion=4.1.1&mid=19930";
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    Gson js = new Gson();
                    list= js.fromJson(jsonString,new TypeToken<List<NHand3>>(){}.getType());
                    String text= list.get(0).getTitle();
                    textView.setText(text);
                    String imageurl= list.get(0).getPic_src();
...
//                    imageView.findViewWithTag(urlString);
...
//        gridView= (PullToRefreshGridView) view.findViewById(R.id.L_picId);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String web_url = list.get(0).getWeb_url();
