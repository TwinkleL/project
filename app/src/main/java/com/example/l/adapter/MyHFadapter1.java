 ...
 */
public class MyHFadapter1 extends BaseAdapter {
    List<NHand1> list;
    Context context;
    HandlerUtils handlerUtils;

    public MyHFadapter1(Context context, HandlerUtils handlerUtils, List<NHand1> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String image = list.get(position).getPic_src();
